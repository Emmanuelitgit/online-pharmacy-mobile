...
import { SafeAreaView, View, Text, StyleSheet, Image, Pressable, StatusBar } from 'react-native';
                ...
                {appointments.map((item) => (
                    <View style={styles.appointmentContainer} key={item?._id}>
                        <View style={styles.itemContainer}>
                            <Image source={require("../../assets/services/zaid.jpg")} style={styles.image} />
                        ...
                        <View style={styles.dateContainer}>
                            <Text>{getTimeUntilAppointment(item?.date, removeSeconds(item?.time))}</Text>
                            <Text style={styles.date}>{formatDate(item?.date) + ', ' + removeSeconds(item?.time)}</Text>
                        </View>
                    </View>
                ))}
            </View>
