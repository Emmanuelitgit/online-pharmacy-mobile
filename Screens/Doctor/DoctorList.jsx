...
import { SafeAreaView, View, Text, Image, FlatList, StyleSheet, Pressable, StatusBar, TextInput } from 'react-native'
    ...
    <SafeAreaView style={styles.container}>
        <StatusBar backgroundColor={'#0C07F1CC'} barStyle={'light-content'} />
            ...
            <View style={styles.inputContainer}>
              <TextInput placeholder='Search for a doctor here...' 
               style={styles.input}
               value={search}
             />
           </View>
           ...
           <Doctors
            ...
            handleNavigate={() => handleNavigate(item?._id, item?.name, item?.file, item?.role)}
          />
        )}
