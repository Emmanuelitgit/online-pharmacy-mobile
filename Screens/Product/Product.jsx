...
const Product = ({ navigation }) => {
  ...
  const { quantity, handleQuantityDecrement, handleQuantityIncrement } =
        ...
        <View style={styles.itemsContainer}>
          ...
          <View style={styles.cardContainer}>
            <View style={styles.imageContainer}>
              <Image
                source={{
                  uri: `https://pharmacy-ordering-server.onrender.com/${product?.file}`,
                }}
                style={styles.image}
              />
            </View>
          ...
          <View style={styles.descContainer}>
            ...
            <Text style={styles.descText}>
              Lufart is a highly effective antimalarial medication used to treat
              uncomplicated malaria caused by Plasmodium falciparum. This
              combination therapy contains artemether and lumefantrine, which
              work together to eliminate the malaria parasite from the
              bloodstream.
            </Text>
          </View>
